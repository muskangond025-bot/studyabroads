...
const slides: SlideData[] = [
  {
    ...
    subtitle: 'Elite Admissions Advisory',
    description:
      'From initial profile shaping and university selection lists to personal essay mentorship, our elite strategic admissions consulting secures placements at Oxford, Cambridge, Harvard, and other top-tier global institutions.',
    accent: '#d4af37',
    imageUrl:
      'https://images.unsplash.com/photo-1541339907198-e08756dedf3f?w=900&h=1200&fit=crop&q=80',
  },
  {
    title: 'Scholarship Strategy',
    subtitle: 'Merit Fellowships & Grants',
    description:
  ...
  },
  {
    ...
    subtitle: 'Direct Immigration Pathways',
    description:
      'Navigating visa compliance can be daunting. Our immigration consultants provide meticulous documentation auditing, mock visa interview training, and direct pathways for international students.',
    accent: '#d4af37',
    imageUrl:
      'https://images.unsplash.com/photo-1507679799987-c73779587ccf?w=900&h=1200&fit=crop&q=80',
  },
  {
    title: 'Essay Mentorship',
    subtitle: 'Technical Statement Styling',
    description:
      'Your essay is your intellectual fingerprint. We mentor scholars to craft compelling, unique research statements and impactful personal stories that resonate with selective admissions committees.',
    accent: '#d4af37',
    imageUrl:
      'https://images.unsplash.com/photo-1456513080510-7bf3a84b82f8?w=900&h=1200&fit=crop&q=80',
  },
];
